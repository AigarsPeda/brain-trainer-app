...
export const BOSS_RETRY_COST = 15;
export const BOSS_RETRY_WAIT_MINUTES = 30;
export const BOSS_RETRY_WAIT_MS = BOSS_RETRY_WAIT_MINUTES * 60 * 1000;
...
export const BOSS_RETRY_PURCHASE_LABEL = "Atkārtot bossu";
...
export const BOSS_RETRY_DESCRIPTION = `Atkārto boss līmeni ar dimantiem, vai nopelni dimantus no reklāmas. Ja nevēlies tērēt dimantus, vari gaidīt ${BOSS_RETRY_WAIT_MINUTES} minūtes un mēģināt bez maksas.`;
